      ...
      <section className="max-w-6xl mx-auto px-6 md:px-12 py-20 space-y-6">
        <div className="space-y-4">
          ...
          <p className="text-white/70 max-w-3xl leading-relaxed">
            {copy.pages.aboutIntro}
          </p>
        </div>
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 text-white/60">
          {lang === "bg"
            ? "Биография, процес и вдъхновение ще бъдат добавени тук. За контакт използвайте социалните мрежи."
            : "Biography, process, and inspiration will be shared here soon. For contact, please use the social links."}
        </div>
      </section>
    </main>
  );
