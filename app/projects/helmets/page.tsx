      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-20 space-y-10">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold">
            {copy.nav.subtabs.helmets}
          </h1>
          <p className="text-white/70 max-w-3xl leading-relaxed">
            {lang === "bg" ? "Уникални дизайни и графично оформление на каски за мотоциклетисти." : "Unique designs and graphic styling for motorcycle helmets."}
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <Link
            href="/projects/helmets/helmet-collection"
          ...
          >
            <div
              ...
              style={{ backgroundImage: `url('/images/helmets/helmets10.webp')` }}
            />
            <div className="relative space-y-3">
              <h3 className="text-3xl font-serif font-bold">{lang === "bg" ? "Колекция Каски" : "Helmet Collection"}</h3>
